...
public class Leave implements Serializable {
    ...
    public Leave(String userId, Boolean submit, Date startDate, Date endDate, float totalDay, String desc, String taskId, String taskName, String approver1, Boolean agree1, String approveDesc1, String approver2, Boolean agree2, String approveDesc2) {
        this.userId = userId;
        this.submit = submit;
